...
export default function AvisoLegalPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <p className={pClass}>
        La titularidad de este sitio web, https://openfit-five.vercel.app, (en adelante, Sitio Web) la ostenta: <strong>Rubén Fernández Personat</strong>, con NIF <strong>23879574-P</strong>, y cuyos datos de contacto son:
      </p>
      ...
      <ul className={ulClass}>
        <li>Un uso de la información, Contenidos y/o Servicios y datos ofrecidos por Openfit sin que sea contrario a lo dispuesto por las presentes Condiciones, la Ley, la moral o el orden público, o que de cualquier otro modo puedan suponer lesión de los derechos de terceros o del mismo funcionamiento del Sitio Web.</li>
        <li>La veracidad y licitud de las informaciones aportadas por el Usuario en los formularios extendidos por Openfit para el acceso a ciertos Contenidos o Servicios ofrecidos por el Sitio Web. En todo caso, el Usuario notificará de forma inmediata a Openfit acerca de cualquier hecho que permita el uso indebido de la información registrada en dichos formularios, tales como, pero no solo, el robo, extravío, o el acceso no autorizado a identificadores y/o contraseñas, con el fin de proceder a su inmediata cancelación.</li>
